    ...
    <section id="kontak" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            <div className="space-y-6 sm:space-y-8">
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Alamat</h3>
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">{contactInfo.address}</p>
                  {/* <a
        ...
        <div className="mt-12 sm:mt-16">
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 text-center">Lokasi Kami</h3>
